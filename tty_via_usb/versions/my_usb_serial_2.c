...
static int my_usb_probe(struct usb_interface *interface, const struct usb_device_id *id)
{
    ...
    tty_port_register_device(&dev->tty_port, my_tty_driver, 0, &interface->dev);
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("You");
MODULE_DESCRIPTION("Minimal USB TTY driver with bulk URB support");
